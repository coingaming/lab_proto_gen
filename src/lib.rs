...
pub fn run() -> Result<(), Box<dyn std::error::Error>> {
        ...
        .into_iter()
    {
        ...
        let source_code_info = prost_types::SourceCodeInfo {
            location: vec![prost_types::source_code_info::Location {
                ...
                leading_comments: Some(
                    "CAUTION: this file is autogenerated by lab_proto_gen. Do not edit it manually!"
                        .to_string(),
                ),
        ...
        file.write_all(protobuf_gen::ProtobufString::to_protobuf(&fd.to_owned(), fd).as_bytes())?; 
    }
